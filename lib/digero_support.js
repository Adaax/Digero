...
function formspace(data)
{
	...
	this.data_context.style.width = "220px";
	this.data_context.style.height = "150px";
	...
	this.data_context_close.style.top = "120px";
	...
	this.data_context_cancel.style.top = "120px";
	this.data_context_cancel.style.left = "78px";

	this.data_context_cancel.style.width = "70px";
	...
	this.data_context_label1.style.top = "12px";
	this.data_context_label1.style.left = "5px";
	...
	this.data_context_name.style.top = "5px";
	this.data_context_name.style.left = "48px";

	this.data_context_name.style.width = "160px";
	...
	this.data_context_multi = document.createElement("input");
	this.data_context_multi.type = "checkbox";
	this.data_context_multi.id = data.id + "_data_context_multi";
	this.data_context_multi.style.position = "absolute";

	this.data_context_multi.style.top = "43px";
	this.data_context_multi.style.left = "14px";

	//this.data_context_multi.value = "";

	this.data_context.appendChild(this.data_context_multi);
	...
	this.data_context_label2.style.top = "45px";
	this.data_context_label2.style.left = "45px";

	this.data_context_label2.style.width = "100px";
	...
	this.data_context_label2.innerHTML = "Multi-Row";
	...
	this.add_tab = function(make_object)
	{
		...
		//console.log(Object.keys(objects[obj_index]));
...
window.onkeydown = function(evt) 
{
	...
	{
		alert(document.activeElement.style.class);
	}*/
