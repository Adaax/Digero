...
function formspace(data)
{
	...
	this.data_context.style.width = "290px";
	...
	this.data_context_header.style.width = "290px";
	...
	this.data_context_name.style.top = "38px";
	this.data_context_name.style.left = "53px";

	this.data_context_name.style.width = "200px";
