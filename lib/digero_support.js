...
function functions_dialog(data)
{
	...
	this.functions_div_name.style.top = "31px";
	this.functions_div_name.style.left = "1px";

	this.functions_div_name.style.width = (Math.floor((data.width / 5) * 3) - 3) + "px";
	...
	this.functions_div_name.style.paddingLeft = "3px";
	...
	this.functions_div_file.style.top = "31px";
	this.functions_div_file.style.left = (parseInt(this.functions_div_name.style.width) + 5) + "px";

	this.functions_div_file.style.width = (Math.floor((data.width / 5) * 2) - 6) + "px";
	...
	this.functions_div_file.style.paddingLeft = "3px";
	...
	this.explore_container.style.top = "52px";
	...
	this.explore_container.style.height = (data.height - 79) + "px";
			...
			if (main_formspace.tab_editors[i] != undefined)
			{
				...
				do
				{
					...
					if (func_pos != -1)
					{
						...
						funcs[index] = {};
						funcs[index].name = code.substring(name_start_pos, name_end_pos);
						funcs[index].type = "function";
						funcs[index].file = main_formspace.tab_names[i].innerHTML;

						if (funcs[index].name.substring(0, 5) == "this.")
						{
							parent_index = index - 1;

							if (funcs[parent_index].childs == undefined)
								funcs[parent_index].childs = new Array();

							funcs[parent_index].childs[funcs[parent_index].childs.length] = funcs[index].name;
				...
				do
				{
					...
					if (func_pos != -1)
					{
						...
						if (code.substr(object_start_pos - 1, 1) == "(")
						{
							...
							funcs[index] = {};
							funcs[index].name = object_name + "." + event_name;
							funcs[index].type = "event";
							funcs[index].file = main_formspace.tab_names[i].innerHTML;
						}
