...
function functions_dialog(data)
{
	...
	this.functions_div_search.style.width = (data.width - 10) + "px";
	...
	this.functions_div_search.addEventListener("keypress", function (funcs)
	{
		return function(evt)
		{
	...
	this.go_functions = function()
	{
			...
			if (main_formspace.tab_editors[i] != undefined)
			{
				...
				do
				{
					...
					if (func_pos != -1)
					{
						...
						this.funcs[index].code = code.substr(name_start_pos, 40);
				...
				do
				{
					...
					if (func_pos != -1)
					{
						...
						if (code.substr(object_start_pos - 1, 1) == "(")
						{
							...
							this.funcs[index].file = main_formspace.tab_names[i].innerHTML;
							this.funcs[index].code = code.substr(func_start_pos, 70);
						}
		...
		for (var i = 0; i < this.funcs.length; i++)
		{
			...
			entry_div.addEventListener("dblclick", function (func)
			{
				return function(evt)
				{
					//main_explore.explore_highlight.style.top = (index * 20) + "px";
			...
			entry_name_div.style.color = "#dddddd";
			...
			entry_file_div.style.color = "#dddddd";
	...
	this.highlight(index)
	{
		...
		document.getElementById(this.id + "_entry_" + index).style.backgroundColor = "#3f3f46";
	}
